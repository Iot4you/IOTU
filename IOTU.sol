...
contract TRC20 is ITRC20, Ownable {
    ...
    function payDividends() payable public onlyOwner {
      ...
      totalDivPoints = totalDivPoints.add(weiAmount.mul(pointMultiplier).div(_totalSupply));
...
contract IOTU is TRC20Burnable {
    string public constant name = "Internet of things for you";
